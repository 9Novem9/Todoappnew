                                      ...
                                      <div class="flex justify-end">
                                          <div>
                                              <form action="/tasks/<?php echo e($item->id); ?>"
                                                  ...
                                                  <button type="submit"
                                                      class="bg-emerald-700 py-4 w-20 text-white md:hover:bg-emerald-800 transition-colors">未完了に戻る</button>
                                              </form>
                                          </div>
...
</html><?php /**PATH C:\Users\CRE\Documents\Todoappnew\resources\views/history/index.blade.php ENDPATH**/ ?>